...
namespace PerfumeStore.Areas.Admin.Migrations
{
    ...
    [Migration("20251010031756_AdminInitialCreate")]
            ...
            modelBuilder.Entity("EqualCategory", b =>
                {
                    ...
                    b.HasKey("ProductId", "CategoryId")
                        .HasName("PK__EqualCat__159C554F0E2DFE61");
            ...
            modelBuilder.Entity("RolePermission", b =>
                {
                    ...
                    b.HasKey("RoleId", "PermissionId")
                        .HasName("PK__RolePerm__6400A1889F722F46");
            ...
            modelBuilder.Entity("EqualCategory", b =>
                {
                    b.HasOne("PerfumeStore.Models.Category", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK__EqualCate__Categ__08B54D69");

                    b.HasOne("PerfumeStore.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .IsRequired()
                        .HasConstraintName("FK__EqualCate__Produ__07C12930");
                });
            ...
            modelBuilder.Entity("RolePermission", b =>
                {
                    b.HasOne("PerfumeStore.Models.Permission", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK__RolePermi__Permi__440B1D61");

                    b.HasOne("PerfumeStore.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .IsRequired()
                        .HasConstraintName("FK__RolePermi__RoleI__4316F928");
                });
