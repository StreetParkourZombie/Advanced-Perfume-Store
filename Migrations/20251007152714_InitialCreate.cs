        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpinNumber = table.Column<int>(type: "int", nullable: true, defaultValueSql: "((0))"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Admins__RoleID__46E78A0C",
                        column: x => x.RoleID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__RolePerm__6400A1889F722F46", x => new { x.RoleID, x.PermissionId });
                    table.ForeignKey(
                        name: "FK__RolePermi__Permi__440B1D61",
                        column: x => x.PermissionId,
                        principalTable: "Permissions",
                        principalColumn: "PermissionId");
                    table.ForeignKey(
                        name: "FK__RolePermi__RoleI__4316F928",
                        column: x => x.RoleID,
                        principalTable: "Roles",
                        principalColumn: "RoleID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__WarrantyC__Warra__534D60F1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__EqualCat__159C554F0E2DFE61", x => new { x.ProductID, x.CategoryID });
                    table.ForeignKey(
                        name: "FK__EqualCate__Categ__08B54D69",
                        column: x => x.CategoryID,
                        principalTable: "Categories",
                        principalColumn: "CategoryID");
                    table.ForeignKey(
                        name: "FK__EqualCate__Produ__07C12930",
